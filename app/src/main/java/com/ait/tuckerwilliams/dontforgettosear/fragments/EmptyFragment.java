 ...
 * {@link EmptyFragment.OnEmptyFragmentListener} interface
...
public class EmptyFragment extends Fragment {
    ...
    private OnEmptyFragmentListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnEmptyFragmentListener) {
            mListener = (OnEmptyFragmentListener) context;
        } else {
     ...
     */
    public interface OnEmptyFragmentListener {

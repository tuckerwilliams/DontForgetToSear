...
public class RecipesListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    protected ArrayList<Recipe> mList;
    private Context context;
    private Realm realm;

    public RecipesListAdapter(ArrayList<Recipe> items, OnRecipeFragmentListener listener, Context context) {
...
//        });
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DisplayRecipeFragment myFrag = DisplayRecipeFragment.newInstance(recipeObj.getRecipeName(), "string2");
                myFrag.setRecipe(recipeObj);
                //Create a bundle to pass data, add data, set the bundle to your fragment and:
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.mainUIContainer, myFrag).addToBackStack(null).commit();
            }
        });
    }
    ...
    public void setRecipeRowThumbnail(final RecyclerView.ViewHolder holder, String type) {
        switch (type) {
            case "Burgers":
